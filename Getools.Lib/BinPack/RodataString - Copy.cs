...
{
    public class OriginalRodataString
    {
        /// <summary>
        ...
        /// </summary>
        private class RodataString : IGetoolsLibObject, IBinData
        {
            private bool _cancelAssemble = false;
            ...
            /// <summary>
            /// Call <see cref="Collect(IAssembleContext)"/> first.
            /// </summary>
            /// <param name="dataSection"></param>
            /// <param name="rodataSection"></param>
            public void SetAssemble(bool dataSection, bool rodataSection)
            {
                _cancelAssemble = !dataSection;

                if (!object.ReferenceEquals(null, _rodataString))
                {
                    if (rodataSection)
                    {
                        _rodataString.EnableAssemble();
                    }
                    else
                    {
                        _rodataString.DisableAssemble();
                    }
                }
            }
            ...
            private class PointedToString : IBinData, IGetoolsLibObject
            {
                ...
                public void DisableAssemble()
                {
                    _cancelAssemble = true;
                }

                public void EnableAssemble()
                {
                    _cancelAssemble = false;
                }
