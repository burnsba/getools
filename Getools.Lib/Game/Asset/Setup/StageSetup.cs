...
//        /// <summary>
//        /// C file, default variable declaration.
//        /// </summary>
//        public const string DefaultDeclarationName = "setup";

//        public const string DefaultDeclarationName_padlist = "padlist1";
//        public const string DefaultDeclarationName_pad3dlist = "pad3dlist";
...
//        internal static StageSetup ReadFromBinFile(BinaryReader br)
//        {
...
//            foreach (var filename in StageSetup.IncludeHeaders)
//            {
...
//        private void WriteToCFile_ForwardDeclarations(StreamWriter sw)
//        {
//            sw.WriteLine("// forward declarations");
//            sw.WriteLine($"{Pad.CTypeName} {DefaultDeclarationName_padlist}[];");
//            sw.WriteLine($"{Pad3d.CTypeName} {DefaultDeclarationName_pad3dlist}[];");
//            sw.WriteLine();
//        }
