...
{
    /// <summary>
    /// Setup object list / prop definition for tank.
    /// </summary>
    public class SetupObjectTank : SetupObjectGenericBase
    {
        private const int _thisSize = 96;

        public const int SizeOf = GameObjectHeaderBase.SizeOf + _thisSize;

        /// <summary>
        /// Initializes a new instance of the <see cref="SetupObjectTank"/> class.
        /// </summary>
        public SetupObjectTank()
            : base(PropDef.Tank)
        {
        }
